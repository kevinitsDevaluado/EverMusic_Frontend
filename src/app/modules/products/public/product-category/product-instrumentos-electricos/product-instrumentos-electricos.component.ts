...
@Component({
  selector: 'app-product-instrumentos-electricos',
  templateUrl: './product-instrumentos-electricos.component.html',
  styleUrls: ['./product-instrumentos-electricos.component.css']
})
export class ProductInstrumentosElectricosComponent implements OnInit {
  ...
  getAllProducts() {
    this.service.getAllInstrumentosElectricos().subscribe(
      data => {
